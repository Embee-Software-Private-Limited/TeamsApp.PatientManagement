...
namespace TeamsApp.PatientManagement.Bot
{
    ...
    /// <summary>
    /// The LocalizationCultureProvider is responsible for implementing the <see cref="IRequestCultureProvider"/> for Bot Activities
    /// received from BotFramework.
    /// </summary>
    internal sealed class AppLocalizationCultureProvider : IRequestCultureProvider
    {
        /// <summary>
